 ...
 * Generated: 2026-08-13T03:19:43.851Z
 */
...
export const gudocsTheme = {
  ...
  tokens: {
    ...
    "--color-background-surface": "light-dark(#FDFBFF, #1C1B21)",
    "--color-background-body": "light-dark(#F1EFF9, #121017)",
    "--color-background-card": "light-dark(#FDFBFF, #1C1B21)",
    "--color-background-popover": "light-dark(#FDFBFF, #312F37)",
    "--color-background-muted": "light-dark(#1C1B210D, #1C1B2180)",
    "--color-accent": "light-dark(#1F4DF3, #C9BEFF)",
    ...
    "--color-text-primary": "light-dark(#202632, #E2E1EB)",
    "--color-text-secondary": "light-dark(#484552, #ACA9B8)",
    "--color-text-disabled": "light-dark(#928F9D, #5F5D6A)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #002298)",
    ...
    "--color-icon-secondary": "light-dark(#484552, #ACA9B8)",
    "--color-icon-disabled": "light-dark(#928F9D, #5F5D6A)",
    ...
    "--color-border": "light-dark(#2026321A, #F0F0F91A)",
    "--color-border-emphasized": "light-dark(#20263259, #464552)",
    "--color-skeleton": "light-dark(#ACA9B8, #484552)",
    ...
    "--color-background-inverted": "light-dark(#1C1B21, #FDFBFF)",
    "--color-track": "light-dark(#ACA9B8, #484552)",
    "--radius-chat": "42px"
  },
