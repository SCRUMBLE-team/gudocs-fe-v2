import { HomeIcon, MyIcon, SubscriptionIcon } from "../activities/home/tab-icons";
 ...
 * 통계(StatsIcon) 탭은 대응 화면이 아직 없어서 — 전에는 눌러도 매칭되는
 * 라우트가 없어 빈 화면이 떴다 — 화면이 생길 때까지 목록에서 뺀다.
 */
...
export const TABS = [
  ...
  { activity: "My", label: "마이", icon: MyIcon },
] as const;
